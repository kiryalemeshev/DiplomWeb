...
try {
    ...
    $params = [
        'q10' => "Критическое мышление, анализ данных, навыки программирования",
        'q11' => "Коммуникативные навыки, навыки презентации",
        'q12' => "Работы в команде, научно-исследовательские навыки",
    ];
    ...
    if ($posts) {
        // Создаем CSV данные
        $filename = 'opros_results_4.csv'; // Другое имя файла, чтобы не перезаписать
