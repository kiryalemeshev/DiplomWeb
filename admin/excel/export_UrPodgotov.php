...
try {
    ...
    $params = [
        'q10' => "Работа с компьютером",
        'q11' => "Математические расчеты и анализ данных",
        'q12' => "Работа с научными источниками и литературой",
    ];
    ...
    if ($posts) {
        // Создаем CSV данные
        $filename = 'opros_results_5.csv'; // Другое имя файла, чтобы не перезаписать
