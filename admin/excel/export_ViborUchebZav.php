...
try {
    ...
    $params = [
        'q10' => "Репутация учебного заведения",
        'q11' => "Качество образовательных программ",
        'q12' => "Наличие интересующей вас специальности",
    ];
    ...
    if ($posts) {
        // Создаем CSV данные
        $filename = 'opros_results_3.csv'; // Другое имя файла, чтобы не перезаписать
