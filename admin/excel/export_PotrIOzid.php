...
try {
    ...
    $params = [
        'q10' => "Наличие и качество общежития",
        'q11' => "Размер стипендии",
        'q12' => "Наличие студенческого клуба/культурного центра",
    ];
    ...
    if ($posts) {
        // Создаем CSV данные
        $filename = 'opros_results_2.csv'; // Другое имя файла, чтобы не перезаписать
