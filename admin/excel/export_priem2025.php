...
try {
    ...
    $params = [
        'q10' => "Недостаточная компетентность сотрудников и их количество",
        'q11' => "Отсутствие четких ответов на вопросы",
        'q12' => "Недостаточно вежливое отношение",
    ];
    ...
    if ($posts) {
        // Создаем CSV данные
        $filename = 'opros_results_7.csv'; // Другое имя файла, чтобы не перезаписать
