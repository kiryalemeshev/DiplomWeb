    ...
    <div class="posts col-9">
        ...
        <?php foreach ($postsAdm as $key => $post): ?>
            <div class="row post">
                ...
                <div class="title col-5"><?= mb_strimwidth($post['title'], 0, 50, '...' , 'UTF-8') ?></div>
                ...
                <?php endif; ?>
               <!-- <div class="export col-1"><a href="export.php?id=<?=$post['id'];?>">Export</a></div>
                <div class="analysis col-1">
                    <a href="get_chart_data.php?id=<?=$post['id'];?>"  target="_blank">Анализ</a>
